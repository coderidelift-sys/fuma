  ...
  <AuthenticatedLayout>
    <template #default>
      <div class="container py-4">
        <h2 class="mb-4">Edit Turnamen</h2>
...
usePage().props.title = 'Edit Turnamen'
const form = reactive({
  name: props.tournament.name,
  description: props.tournament.description,
  logo_url: props.tournament.logo_url,
...
function submit() {
  router.put(route('admin.tournaments.update', props.tournament.id), form)
}
</script>
